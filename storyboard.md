...
Annmarie's mind map shows the overall framework of the website. It starts out with pages the website should have and branch out into more details of each page. The Crazy Eights mainly showcase interactive features that can be added to the website. The group's favorite features were the randomize button that recommends art on the map to a user, and a search bar where users can look up different art and artists. 
